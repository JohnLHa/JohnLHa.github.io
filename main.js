...
module.exports = "<style>\r\n  @import url('https://fonts.googleapis.com/css?family=Merienda');\r\n</style>\r\n<div class=\"page-header\">\r\n  <div class=\"page-border\">\r\n    <h1>{{titleOne}}</h1>\r\n    <h1>{{titleTwo}}</h1>\r\n    <!-- <img src=\"../assets/logo.png\"> -->\r\n    <p style=\"font-family: 'Merienda', cursive\">\r\n      <i>\"BE WATCHFUL, STAND FIRM IN THE FAITH, ACT LIKE MEN, BE STRONG.” ~ 1 CORINTHIANS 16:13</i>\r\n    </p>\r\n  </div>\r\n\r\n</div>\r\n\r\n<div class=\"page-border\">\r\n  <router-outlet>\r\n    \r\n  </router-outlet>\r\n</div>"
...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.titleOne = 'Northeast Christian Family Camp 2019';
...
var AttendeeFormComponent = /** @class */ (function () {
    function AttendeeFormComponent(fb, http, userService) {
        ...
        this.has_cottage = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("");
        ...
        this.model = new _models_Attendee__WEBPACK_IMPORTED_MODULE_1__["Attendee"]("", "", "", "", null, false, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", null);
        // Lists
        this.people = [];
    ...
    AttendeeFormComponent.prototype.addAttendee = function () {
        ...
        if (this.attendeeForm.valid) {
            var attendee = new _models_Attendee__WEBPACK_IMPORTED_MODULE_1__["Attendee"]("", "", "", "", null, false, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", null);
            ...
            attendee.has_cottage = this.has_cottage.value;
    ...
    AttendeeFormComponent.prototype.createNewAttendee = function () {
        ...
        if (this.attendeeForm.valid) {
            this.people.push(new _models_Attendee__WEBPACK_IMPORTED_MODULE_1__["Attendee"]("", "", "", "", null, false, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "Friday, Saturday, Sunday, Monday", null));
            this.max_index++;
    ...
    AttendeeFormComponent.prototype.loadAttendees = function () {
        ...
        if (attendees.length > 0) {
            ...
            this.people.push(new _models_Attendee__WEBPACK_IMPORTED_MODULE_1__["Attendee"]("", "", "", "", null, false, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", null));
    ...
    AttendeeFormComponent.prototype.bindListToForm = function () {
        ...
        this.has_cottage.setValue(this.currentAttendee.has_cottage);
    ...
    AttendeeFormComponent.prototype.fullUpdate = function () {
        this.attendeeForm.setValue({
            ...
            age: 12, has_cottage: false, medical: 'yes', address: '123 Adams Ave', address_2: "N/A", city: "Philadelphia",
...
var Attendee = /** @class */ (function () {
    function Attendee(first_name, last_name, t_shirt, gender, age, has_cottage, medical, address, address_2, city, state, zip_code, email, emergency_contact_first_name, emergency_contact_last_name, emergency_contact_phone_number, emergency_contact_relationship, your_church, your_church_point_of_contact_name, your_church_point_of_contact_number, days_attending, cost) {
        this.first_name = first_name;
        this.last_name = last_name;
        this.t_shirt = t_shirt;
        this.gender = gender;
        this.age = age;
        this.has_cottage = has_cottage;
...
var ReviewPageComponent = /** @class */ (function () {
    function ReviewPageComponent(cd, userService, http, router, fs) {
        ...
        // Production URL
        this.webtask_payment_url = 'https://wt-0abace7df40ea939072b329aa74c0316-0.sandbox.auth0-extend.com/webtask-stripe-payment';
        this.loading = false;
        this.email = '';
        // Cost calculation variables
        this.fixed_price = false; // set to true when fixed price, else false.
        this.total_cost = 0;
        this.base_price = 155;
    ...
    ReviewPageComponent.prototype.calculateCosts = function () {
        var _this = this;
        if (this.fixed_price) {
            ...
            this.registers.forEach(function (x) {
                if (x.has_cottage) {
                    if (x.age > 5) {
                        x.cost = 90;
                    }
                    ...
                    else if (x.age > 5 && x.age <= 12) {
                        x.cost = 60;
                    }
                    else if (x.age > 12 && x.age <= 21) {
                        x.cost = 100;
                    }
                    else {
                        x.cost = 120;
                ...
                _this.total_cost = _this.total_cost + x.cost;
                _this.original_cost = _this.original_cost + x.cost;
            });
        }
    };
...
var FirestoreService = /** @class */ (function () {
    function FirestoreService() {
        this.collection = firebase__WEBPACK_IMPORTED_MODULE_2__["firestore"]().collection('haluwasa-attendees');
    }
...
module.exports = __webpack_require__(/*! C:\Users\John Ha\Documents\Camps\CVCF\Code\registration\src\main.ts */"./src/main.ts");
