...
var AttendeeFormComponent = /** @class */ (function () {
    ...
    function AttendeeFormComponent(fb, http, userService) {
        ...
        this.days_attending = "";
        this.people = [];
        this.sizes = ['Select Size', 'S', 'M', 'L', 'XL', 'XXL'];
        this.genders = ['Select Gender', 'Male', 'Female'];
        this.states = ["Select State", "AK", "AL", "AR", "AZ", "CA", "CO", "CT", "DE", "FL", "GA", "HI",
...
var ReviewPageComponent = /** @class */ (function () {
    ...
    ReviewPageComponent.prototype.postToGoogle = function () {
        ...
        function () { _this.loading = false; }, function () { _this.loading = false; });
    };
